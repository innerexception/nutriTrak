	...
	var appReducer = function appReducer() {
	    ...
	    switch (action.type) {
	        case 'LOAD_MONTH_VIEW':
	            return { viewState: _extends({}, viewState, { activeView: 'month', nutritionMonth: action.nutritionMonth ? action.nutritionMonth : viewState.nutritionMonth, nutritionDay: null, activeDayDetails: null }) };
	        case 'LOAD_DAY_VIEW':
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UIManagerHelper = __webpack_require__(199);
...
/***/ function(module, exports, __webpack_require__) {
	        ...
	        nutritionMonth.map(function (nutritionDay) {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement('div', { className: 'nutrition-day-bar-bar', style: { width: nutritionDay.rating * 10 + '%' } }),
	                    _react2.default.createElement(
	                        'div',
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'nutrition-day-detail ' + (showDayDetails ? 'in' : 'out') },
	        ...
	        _react2.default.createElement(
	            ...
	            nutritionDay.meals.map(function (meal) {
	                ...
	                return _react2.default.createElement('div', { className: 'nutrition-meal', onMouseEnter: function onMouseEnter() {
	                    ...
	                    }, style: { width: meal.rating * 10 + 'px', paddingLeft: leftPadding * 10 + 'px' } });
	            })
	        ),
	        _react2.default.createElement(
	            'div',
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement('div', { className: 'nutrition-day-icon' }),
	                _react2.default.createElement('div', { className: 'nutrition-meal-btn', style: { top: getPercentFromTimeOfDay(new Date()) + '%' }, onClick: onAddMealClicked }),
	                _react2.default.createElement('div', { className: 'nutrition-night-icon' }),
	                _react2.default.createElement('div', { className: 'nutrition-day-back-btn', onClick: onGotoCalendarClicked })
	            )
	        )
	    );
	};
	...
	var getMealRating = function getMealRating(meal) {
	    ...
	    var mealRating = 0;
	    Object.keys(_Constants2.default.dailyTargets).forEach(function (type) {
	        mealRating += mealCounts[type] / _Constants2.default.dailyTargets[type];
	    });
	    return mealRating;
	};
